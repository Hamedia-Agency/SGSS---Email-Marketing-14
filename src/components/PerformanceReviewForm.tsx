...
import styles from './PerformanceReviewForm.module.css';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        source: 'Secure Guard CTA Form',
        formType: 'Security Consultation Request',
      ...
      <div className={styles.eyjiCtaInner}>
        <div className={styles.eyjiCtaPanel}>
          ...
          <div className={styles.eyjiCtaCopy}>
            ...
            <p className={styles.eyjiCtaText} style={{ marginBottom: '1rem' }}>
              Proactive security is all about identifying potential risks before they turn into costly incidents. Whether you want to optimize your existing security setup or simply get a fresh, expert perspective on your property's visual blind spots, our team is ready to help.
            </p>
            <p className={styles.eyjiCtaText}>
              Fill out the quick form below or give us a call to connect with a specialist. We'll review your site details, answer your questions, and share practical ways to strengthen your property's defense.
            </p>
